...
from func import gen_df_features_targets, genft_df_gaia, concat, MAG, gen_ft_dif_splus_x
...
'''
Pegar features do S-PLUS, diferenças de magnitude em relação aos filtros largos e
estreitos de suas respectivas bandas. Targets tem classificação binária, se é WD
ou Other Stars e sua respectiva source_id
'''
...
#só pega as 3 features do gaia, rp,bp e paralaxe e os índices de objetos que não
#tem nan ou paralaxes positivas naquelas features
...
features_splus1, targets_data1 = features_splus1.iloc[non_null_index1],\
    targets_data1.iloc[non_null_index1]
#mesma coisa
features_splus2, targets_data2 = features_splus2.iloc[non_null_index2], \
...
#Mesma coisa, mas para features do GAIA
